...
var require_parser_generated = __commonJS((exports, module) => {
...
`, "\r", "(", ":", ")"], true, false, false);
    function peg$f0(links) {
      return links;
    }
    function peg$f1() {
      return [];
    }
    function peg$f2(fl, list) {
      popIndentation();
    ...
    function peg$f14(list) {
      return list;
    }
    function peg$f15(value) {
      return value;
    }
    function peg$f16(list) {
      return list;
    }
    function peg$f17(id, v) {
      return { id, values: v };
    }
    function peg$f18(id, v) {
      return { id, values: v };
    }
    function peg$f19(v) {
      return { values: v };
    ...
    function peg$f24(spaces) {
      return spaces.length > getCurrentIndentation();
    }
    function peg$f25(spaces) {
      pushIndentation(spaces);
    }
    function peg$f26(spaces) {
...
class Link {
  ...
  static escapeReference(reference) {
    ...
    const needsSingleQuotes = reference.includes(":") || reference.includes("(") || reference.includes(")") || reference.includes(" ") || reference.includes("\t") || reference.includes(`
...
// src/Parser.js
var parserModule = __toESM(require_parser_generated(), 1);
