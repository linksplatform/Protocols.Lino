...
function peg$parse(input, options) {
  ...
  function peg$f0(links) {    return links.flat();  }
  function peg$f1(fl, list) {    popIndentation(); return [fl].concat(list || []);  }
  function peg$f2(l) {    return l;  }
  function peg$f3(spaces) {    return checkIndentation(spaces);  }
  function peg$f4(spaces, l) {    return l;  }
  function peg$f5(e, l) {    
  ...
  function peg$f11(fl) {    return fl;  }
  function peg$f12(pl) {    return pl;  }
  ...
  function peg$f19(v) {    return { id: null, values: v };  }
  function peg$f20(id, v) {    return { id: id, values: v };  }
  function peg$f21(v) {    return { id: null, values: v };  }
  function peg$f22(v) {    return { values: v };  }
  function peg$f23(v) {    return { values: v };  }
  function peg$f24(id) {    return { id: id };  }
  function peg$f25(l) {    return l;  }
  function peg$f26(l) {    return l;  }
  function peg$f27(chars) {    return chars.join('');  }
  function peg$f28(r) {    return r.join('');  }
  function peg$f29(r) {    return r.join('');  }
  function peg$f30(spaces) {    return spaces.length > getCurrentIndentation();  }
  function peg$f31(spaces) {    pushIndentation(spaces);  }
